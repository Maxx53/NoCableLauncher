...
namespace NoCableLauncher.CoreAudioApi
{
    ...
    public class PolicyConfigClient
    {
        ...
        public void SetEndpointVisibility(string devID, bool eVisible)
        {
            if (_PolicyConfig != null)
            {
                Marshal.ThrowExceptionForHR(_PolicyConfig.SetEndpointVisibility(devID, eVisible));
                return;
            }
            if (_PolicyConfigVista != null)
            {
                Marshal.ThrowExceptionForHR(_PolicyConfigVista.SetEndpointVisibility(devID, eVisible));
                return;
            }
            if (_PolicyConfig10 != null)
            {
                Marshal.ThrowExceptionForHR(_PolicyConfig10.SetEndpointVisibility(devID, eVisible));
            }
        }
    }
}